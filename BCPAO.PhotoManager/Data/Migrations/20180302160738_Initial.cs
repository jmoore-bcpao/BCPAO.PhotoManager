        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingSeq = table.Column<int>(nullable: true),
                    DateTaken = table.Column<DateTime>(nullable: true),
                    FrontPhoto = table.Column<bool>(nullable: true),
                    ImageData = table.Column<byte[]>(nullable: false),
                    ImageName = table.Column<string>(maxLength: 20, nullable: true),
                    ImageSize = table.Column<double>(nullable: false),
                    MasterPhoto = table.Column<bool>(nullable: true),
                    PropertyId = table.Column<int>(nullable: true),
                    PublicPhoto = table.Column<bool>(nullable: true),
                    Status = table.Column<string>(maxLength: 10, nullable: false),
                    UploadedBy = table.Column<string>(maxLength: 20, nullable: false),
